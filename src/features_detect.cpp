...
int main()
{
	...
	vector<Point2f> object_corners(4), scene_corners(5);
	...
	scene_corners[4] = keypointsB[matches[match_min].trainIdx].pt;
	...
	draw_object(image_match, scene_corners, Point2f(image_object.cols, 0));
